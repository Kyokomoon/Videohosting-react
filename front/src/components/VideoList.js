...
const VideoList = () => {
  ...
  // Function to generate a thumbnail URL (you'll need to implement this on your backend)
  const getThumbnailUrl = (videoId) => {
    return `http://localhost:8000/api/videos/${videoId}/thumbnail`;
    // Alternatively, you could use a placeholder image:
    // return "https://via.placeholder.com/320x180?text=No+Thumbnail";
  };

  return (
    <div className="video-list-container">
      <h1 className="video-list-title">Browse Videos</h1>
